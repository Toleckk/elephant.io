...
class Version1X extends AbstractSocketIO
{
    ...
    protected $allowCustomCodes;
    
    public function __construct($url, bool $allowCustomCodes = true, array $options = []){
        $this->allowCustomCodes = $allowCustomCodes;
    ...
    public function write($code, $message = null)
    {
        ...
        if (!is_int($code) || (!$this->allowCustomCodes && (0 > $code || 6 < $code))) {
